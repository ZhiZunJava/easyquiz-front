...
import type { FormDataAdmin } from './components/DialogAdminForm.vue';
import DialogAdminForm from './components/DialogAdminForm.vue';

const INITIAL_DATA: FormDataAdmin = {
  id: null,
  userName: '',
  password: '',
  realName: '',
